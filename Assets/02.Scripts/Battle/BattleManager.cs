...
namespace AFKHero.Battle
{
    ...
    public sealed class BattleManager : MonoBehaviour
    {
        ...
        [Header("전투 시작 연출")]
        [Tooltip("유닛을 배치한 뒤 실제 이동과 공격을 시작하기까지 기다리는 시간입니다.")]
        [SerializeField, Min(0f)] private float battleStartDelay = 2f;
        ...
        [Header("궁극기 시작 무적")]
        [SerializeField, Min(0f)] private float ultimateStartInvincibilityDuration = 0.2f;
        ...
        public bool StartBattle()
        {
            ...
            if (IsBattleRunning())
            {
                Debug.LogWarning("이미 전투가 진행 중이거나 시작 대기 중입니다.", this);
                return false;
            }
            ...
            battleStartRoutine = StartCoroutine(StartBattleAfterDelay());
        ...
        private void CancelBattleStartDelay()
        {
        ...
        {
            return battleStartRoutine != null ||
        ...
        private void TryStartNextUltimate()
        {
            ...
            // 궁극기 실행과 에너지 소비가 모두 성공한 경우에만 무적 적용
            nextUnit.Health?.UltimateCutInInvincibility(ultimateStartInvincibilityDuration);
